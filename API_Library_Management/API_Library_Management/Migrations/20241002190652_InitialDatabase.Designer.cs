...
namespace API_Library_Management.Migrations
{
    ...
    [Migration("20241002190652_InitialDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Library_Management.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Library_Management.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Library_Management.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Library_Management.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Library_Management.Entities.Book", b =>
                {
                    b.HasOne("API_Library_Management.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("API_Library_Management.Entities.Order", b =>
                {
                    b.HasOne("API_Library_Management.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_Library_Management.Entities.User", "User")
                        .WithMany()
